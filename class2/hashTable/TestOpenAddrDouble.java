...
public class TestOpenAddrDouble {
...
///////  OpenAddressing Double
		...
		System.out.println(">>> OpenAddressing-Double");
		OpenAddrDouble myHash = new OpenAddrDouble(chainingTableSize);
