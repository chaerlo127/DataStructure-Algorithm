...
public class GraphInList_Link3 {// Vertices # is fixed, Undirected Graph in List
	...
	public void createGraph() {
		 ...
		 adjacentList = new ArrayList<MyLinkedList3<Node>>();
	}
	...
	public static void main(String[] args) {
		...
		GraphInList_Link3 gm = new GraphInList_Link3();
