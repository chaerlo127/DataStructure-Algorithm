...
//-----------------------------------------------------------
	...
	private int median(int[] data, int p, int r) {
		...
		return median(medianArr, 0, arrSize-1); // sorting 된 것을 바탕으로 그룹의 median 값을 구함. -> 다시 median 값들을 sorting, 현재 arraySize는 기존의 데이터보다 1개가 더 크므로, -1를 해주고 다시 sorting
	}
	...
	public static void main(String[] args) {
		...
		SelectionAdvanced s = new SelectionAdvanced();
