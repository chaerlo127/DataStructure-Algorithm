...
public class AssignmentChaining {
	...
	public AssignmentChaining(int n) {
		m = n;
...
//	Delete 
	...
	public static void main(String[] args) {
		...
		AssignmentChaining mh = new AssignmentChaining(HashTableSize);

		System.out.println("\n *** Chaining ***");
		int testcase =20;
		System.out.println("<< Insert >>");
		for (int i=0;i<testcase;i++) {
			System.out.println(data[i] + " ==> " +  mh.insert(data[i])+ " Count: " + mh.nOfHops + " ");
		...
		for (int i=0;i<testcase;i++) {
			System.out.println(data[i] + " ==> " +  mh.search(data[i])+ " Count: " + mh.nOfHops + " ");
		}
		System.out.println("<< Delete >>");
		for (int i=0;i<testcase;i++) {
			System.out.println(data[i] + " ==> " +  mh.delete(data[i])+ " Count: " + mh.nOfHops + " ");
		}
