...
public class AssginmentOpenAddressingLinear {

	int nOfHops=0;
	int [] hTable;
	int m; // table size
	
	public AssginmentOpenAddressingLinear(int tableSize) {
		m=tableSize;
		hTable = new int [m];
	...
	public static void main(String[] args) {
		...
		AssginmentOpenAddressingLinear mh = new AssginmentOpenAddressingLinear(HashTableSize);
